...
describe('ListElementAction > renders', () => {
  it('Should contains edit and delete Icon', async () => {
    ...
    const menuToggler = wrapper.container.querySelector(
    ...
    expect(
      wrapper.container.querySelector('[data-test="deleteIcon"]')
    ).toBeTruthy();
    expect(
      wrapper.container.querySelector('[data-test="editIcon"]')
    ).toBeTruthy();
  });
});
...
describe('ListElementAction > editAction', () => {
  it('Should contains edit modal', () => {
    ...
    expect(
      wrapper.container.querySelector('[data-test="deleteModal"]')
    ).toBeFalsy();
    expect(
      wrapper.container.querySelector('[data-test="editModal"]')
    ).toBeTruthy();
  });
  ...
  it('Should Contains Content Edit Modal', () => {
    ...
    const editContentModal = wrapper.container.querySelector(
      '[data-test="contentModal"]'
    );
...
describe('ListElementAction > deleteAction', () => {
  ...
  it('Should Contains Actions Buttons', () => {
    ...
    expect(
      wrapper.container.querySelector('[data-test="confirmDeleteButton"]')
    ).toBeTruthy();
    expect(
      wrapper.container.querySelector('[data-test="declineDeleteButton"]')
    ).toBeTruthy();
  });
