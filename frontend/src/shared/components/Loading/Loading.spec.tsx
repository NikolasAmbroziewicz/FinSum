...
describe('Loding > styles > size', () => {
  it('Contains small size styles', () => {
    const wrapper = render(<Loading size={LoadingSize.small} />);
  ...
  it('Contains big size styles', () => {
    const wrapper = render(<Loading size={LoadingSize.large} />);
...
describe('Loding > styles > position', () => {
  it('Contains Position start styles', () => {
    const wrapper = render(<Loading position={LoadingPosition.start} />);
  ...
  it('Contains Position center styles', () => {
    const wrapper = render(<Loading position={LoadingPosition.center} />);
  ...
  it('Contains Position end styles', () => {
    const wrapper = render(<Loading position={LoadingPosition.end} />);
