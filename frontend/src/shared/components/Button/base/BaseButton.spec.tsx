...
describe('BaseButton > Styles', () => {
  it('Contains correct styles when color is Base', () => {
    const wrapprer = render(<BaseButton children={CHILDREN_PROPS} color={ButtonTheme.base} />)
  ...
  it('Contains correcet styles when color is Error', () => {
    const wrapprer = render(<BaseButton children={CHILDREN_PROPS} color={ButtonTheme.error} />)
